...
function answerQuestion(value) {
    ...
    switch (currentQuestionConcept){
        case "spaceNeeded":
            filters.spaceNeeded = value.toLowerCase();
            break;
        case "energy":
            filters.energy = value.toLowerCase();
            break;
        case "shedding":
            filters.shedding = value.toLowerCase();
            break;
        case "goodWithKids":
        ...
        case "groomingRequirements":
            filters.groomingRequirements = value.toLowerCase();
            break;
        case "goodWithPets":
            filters.goodWithPets = value.toLowerCase();
            break;
        case "intelligence":
            filters.intelligence = value.toLowerCase();
            break;
        case "trainability":
            filters.trainability = value.toLowerCase();
            break;
        case "barking":
            filters.barking = value.toLowerCase();
            break;
        case "health":
            filters.health = value.toLowerCase();
            break;
        case "lifespan":
            filters.lifespan = value.toLowerCase();
            break;
        case "weather":
            filters.weather = value.toLowerCase();
            break;
        case "purpose":
            filters.purpose = value.toLowerCase();
            break;
        default:
...
function filterDogs() {
    ...
    dogCards.forEach(card => {
        ...
        if (filters.spaceNeeded && dog.spaceNeeded.toLowerCase() !== filters.spaceNeeded.toLowerCase()) {
            matches = false;
        }
        if (filters.energy && dog.energy.toLowerCase() !== filters.energy.toLowerCase()) {
            matches = false;
        }
        if (filters.shedding && dog.shedding.toLowerCase() !== filters.shedding.toLowerCase()) {
            matches = false;
        }
        ...
        if (filters.groomingRequirements && dog.groomingRequirements.toLowerCase() !== filters.groomingRequirements.toLowerCase()) {
            matches = false;
        }
        if (filters.goodWithPets && dog.goodWithPets.toLowerCase() !== filters.goodWithPets.toLowerCase()) {
            matches = false;
        }
        if (filters.intelligence && dog.intelligence.toLowerCase() !== filters.intelligence.toLowerCase()) {
            matches = false;
        }
        if (filters.trainability && dog.trainability.toLowerCase() !== filters.trainability.toLowerCase()) {
            matches = false;
        }
        if (filters.barking && dog.barking.toLowerCase() !== filters.barking.toLowerCase()) {
            matches = false;
        }
        if (filters.health && dog.health.toLowerCase() !== filters.health.toLowerCase()) {
            matches = false;
        }
        if (filters.lifespan && dog.lifespan.toLowerCase() !== filters.lifespan.toLowerCase()) {
            matches = false;
        }
        if (filters.weather && dog.weather.toLowerCase() !== filters.weather.toLowerCase()) {
            matches = false;
        }
        if (filters.purpose && dog.purpose.toLowerCase() !== filters.purpose.toLowerCase()) {
            matches = false;
        }
